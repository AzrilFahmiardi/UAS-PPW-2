            ...
            <div class="max-w-md mx-auto">
                ...
                <form action="{{ route('pegawai.update') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $data->nama) }}" class="w-full rounded-md border px-3 py-2 text-sm"/>
                    </div>
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="email" name="email" value="{{ old('email', $data->email) }}" class="w-full rounded-md border px-3 py-2 text-sm"/>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3 flex items-center gap-2">
                        <input type="checkbox" name="is_active" id="is_active" {{ $data->is_active ? 'checked' : '' }} />
